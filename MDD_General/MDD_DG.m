...
node_M_cur = NodeAddReduce(node_M_cur,node_G_EV,v_th);
% MDD of GU_S
...
node_M_cur = NodeAddReduce(node_M_cur,node_GS,v_th);
% MDD of N_W
...
node_M_cur = NodeAddReduce(node_M_cur,node_GW,v_th);
...
function node_out = NodeAddReduce(node_P,node_C,v_th)
node_out = NodeAdd(node_P,node_C);
node_out = NodeJudgement_value(node_out,v_th);
