function [EENS,LOLE] = DirectEnumeration(p_steady_T,p_steady_S,p_steady_W)
%% Data definitions
% For the transformer
...
EENS = -transpose(M<0)*(M.*P_M); % calculate EENG, yearly
LOLE = transpose(M<0)*P_M; % calculate LOLE, yearly